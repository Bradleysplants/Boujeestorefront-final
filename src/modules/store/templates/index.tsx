...
const StoreTemplate = ({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-gray">
      <div className="flex flex-col small:flex-row small:items-start py-6 content-container flex-grow" data-testid="category-container" aria-label="Store Product List">
