  ...
  return (
    <div className="bg-slate-gray text-pastel-pink p-6 rounded-md"> {/* Background slate-gray, text pastel-pink */}
      <div className="flex flex-row items-center justify-between mb-6">
        <Heading
          level="h2"
          className="flex flex-row text-3xl-regular gap-x-2 items-baseline font-bold" // Apply bold text
        >
          Shipping Address
        ...
        <form action={formAction}>
          <div className="pb-8">
            <ShippingAddress
              ...
              cart={cart}
              inputClassName={inputClassName} // Pass inputClassName to ShippingAddress
            />
            ...
            {!sameAsBilling && (
              <div>
                <Heading
                  level="h2"
                  className="text-3xl-regular gap-x-4 pb-6 pt-8 font-bold" // Apply bold text
                >
                  Billing address
                </Heading>
                ...
                <BillingAddress
                  cart={cart}
                  countryCode={countryCode}
                  inputClassName={inputClassName} // Pass inputClassName to BillingAddress
                />
              </div>
            )}
            <SubmitButton
