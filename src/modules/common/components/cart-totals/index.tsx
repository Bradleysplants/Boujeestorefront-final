...
const CartTotals: React.FC<CartTotalsProps> = ({ data }) => {
  ...
  return (
    <div>
      <div className="flex flex-col gap-y-2 txt-medium text-pastel-pink">
        <div className="flex items-center justify-between">
          <span className="flex gap-x-1 items-center">
            Subtotal
            <Tooltip content="Cart total excluding shipping and taxes.">
              <InformationCircleSolid color="var(--pastel-pink)" />
            </Tooltip>
          </span>
      ...
      <div className="flex items-center justify-between text-pastel-pink mb-2 txt-medium">
        <span>Total</span>
        <span
