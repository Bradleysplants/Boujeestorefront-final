    ...
    <div className="fixed inset-0 z-40 bg-black bg-opacity-50 flex justify-center items-center" aria-modal="true" role="dialog">
      <div className="bg-slate-gray p-6 rounded-lg max-w-3xl w-full mx-4" style={{ overflowY: 'auto', height: '80vh' }}>
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-semibold text-primary-green">Terms and Conditions</h2>
          <button onClick={onClose} className="text-primary-green hover:text-red-500">
            <span className="text-2xl">×</span>
          </button>
        </div>
        <div className="mt-4 text-pastel-pink" style={{ whiteSpace: "pre-wrap" }}>
